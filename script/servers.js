...
async function openServerChat(serverId, serverData) {
  ...
  nav.innerHTML = `
    <div style="display:flex; gap:10px; align-items:center;">
      <img id="server-header-img" src="${serverData.imgUrl || '../images/default-server.png'}" style="width:2vw;height:2vw;border-radius:12px;object-fit:cover;">
...
bubble.style.background = msg.sender === currentUsername ? '#ffffff27' : '#ffffff27';
...
(() => {
  ...
  async function setupAddServerBtn() {
    ...
    if (!premium) {
      ...
      overlay.style.width = "2.5vw";
      overlay.style.height = "2.5vw";
